...
public function addJob($posts_id, $job_name, $sub_name, $occupation_name, $employment_type, $salary, $hourly_rate, $contact_email, $contact_phone, $application_link){
  $this->db->query('INSERT INTO jobs(posts_id, job_category, job_subcategory, occupation, employment_type, salary, hourly_rate, contact_email, contact_number, application_link  ) 
...
//for the front page
public function getJobs($post_id){
  $this->db->query('SELECT * FROM posts, jobs WHERE posts.post_id=:post_id AND jobs.posts_id=:posts_id');
  //bind params
